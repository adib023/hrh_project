...
b2 = 1/a2(2)*pi;
n = 100;
OX = [linspace(0,b1,n)'*a1(1) zeros(n,1)];
XM = [b1*a1(1)*ones(n,1) linspace(0,b2,n)'*a2(2)];
MY = [linspace(b1,0,n)'*a1(1) b2*a2(2)*ones(n,1)];
YO = [zeros(n,1) linspace(b2,0,n)'*a2(2)];
...
scatter(wList_p(:,1),wList_p(:,2),5,'red','filled','o')
hold on
scatter(wList_s(:,1),wList_s(:,2),5,'black','filled','o')
